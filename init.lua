...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>/', '<cmd>Telescope live_grep_args<cr>', { noremap = true, silent = true, desc = '[G]rep with [A]rgs' })
      vim.keymap.set('n', '<leader>/c', live_grep_args_shortcuts.grep_word_under_cursor)
